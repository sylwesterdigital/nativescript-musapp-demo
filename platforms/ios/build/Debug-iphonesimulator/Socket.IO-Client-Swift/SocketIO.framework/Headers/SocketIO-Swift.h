...
///
/// \endcode
SWIFT_CLASS_NAMED("OnAckCallback")
...
SWIFT_CLASS_NAMED("SocketAckEmitter")
...
/// If <code>true</code>, then the engine is currently in WebSockets mode.
@property (nonatomic, readonly) BOOL websocket SWIFT_DEPRECATED_MSG("No longer needed, if we're not polling, then we must be doing websockets");
/// When <code>true</code>, the WebSocket <code>stream</code> will be configured with the enableSOCKSProxy <code>true</code>.
@property (nonatomic, readonly) BOOL enableSOCKSProxy;
/// The WebSocket for this engine.
@property (nonatomic, readonly, strong) WebSocket * _Nullable ws;
/// The client for this engine.
...
SWIFT_CLASS_NAMED("SocketIOClient")
...
///
/// \endcode
SWIFT_CLASS_NAMED("SocketRawView")
